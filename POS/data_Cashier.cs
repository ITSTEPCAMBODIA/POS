...
namespace POS
{
    public class data_Cashier
    {
        public string set_firstName { get; set; }
        public string set_lastName { get; set; }
        public string set_age { get; set; }
        public string set_hiredate { get; set; }
